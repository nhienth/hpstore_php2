...
<div class="right-bgc">
            ...
            <div class="form-funtcion">
                <form action=".?controller=c_1&&action=edited_pro" method="post" class="form-add--product" enctype="multipart/form-data">
                    ...
                    <button> <a href=".?controller=c_1&&action=show_product"> Danh sách </a></button>
                </form>
            </div>
