        ...
        <div class="layout-left">
          ...
          <div class="left-emelent">
            <div class="left-element--content">
              <a href=".?controller=c_2&&action=default" class="none-after"><i class="fas fa-tv"></i> Trang chủ admin</a>
            </div>
          </div>
          <div class="left-emelent">
            ...
            <div class="left-element--content">
              <!-- <div class="more-function">
                <a href=".?controller=c_2&&action=add_user">Thêm tài khoản</a>
                <a href=".?controller=c_2&&action=show_user">Danh sách</a>
              </div> -->
              <a href=".?controller=c_2&&action=show_user"><i class="fas fa-user"></i> Tài khoản</a>
            </div>
          </div>
          ...
          <div class="left-emelent">
            ...
            <div class="left-element--content">
              <a href=".?controller=c_2&&action=show_bill"><i class="fas fa-people-carry"></i> Đơn hàng</a>
            </div>
          </div>
          <div class="left-emelent">
            <div class="left-element--title">Quản lý bình luận</div>
            <div class="left-element--content">
              <a href=".?controller=c_2&&action=show_comment"><i class="fas fa-comment-alt"></i> Bình luận</a>
            </div>
          </div>
          <div class="left-emelent">
          ...
          <div class="left-emelent">
            ...
            <div class="left-element--content">
            <div class="more-function">
                <a href=".?controller=c_2&&action=stat_pro">Hàng hóa</a>
                <a href=".?controller=c_2&&action=stat_bill">Đơn hàng</a>
              </div>
              <a href=".?controller=c_2&&action=stat_pro"><i class="fas fa-chart-pie"></i> Thống kê</a>
            </div>
          </div>
        </div>
