          ...
          ?>
              ...
              <div class="function-table">
                ...
                <tr>
                    <td colspan="5" class="table-td-button"> 
                        <button class="btn-chart"> <a href=".?controller=c_2&&action=show_chartpro"> Xem biểu đồ</a> </button>
                    </td>
                </tr>
            ...
            <div class="mb50">
              ...
              <div class="function-table">
                ...
                <tr>
                    <td colspan="5" class="table-td-button"> 
                        <button class="btn-chart"> <a href=".?controller=c_2&&action=show_chartprom"> Xem biểu đồ</a> </button>
                    </td>
                </tr>
